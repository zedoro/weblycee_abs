...
$query = "SELECT * FROM personnel,absences,lieux WHERE absences.LID = lieux.LID AND personnel.PRID = absences.PRID AND absences.PRID=".$prID." AND absences.categorie='".$categorie."' ";
	if(mysql_result($profID,0,"print")==0) $query .= "AND absences.print=0";
	else $query .="AND absences.ABID =".$abID;
//echo $query."<br>"; // DEBUG
...
$query =  "SELECT * FROM textes WHERE categorie = '".$categorie."'";
$textes = mysql_query($query,$ma_base);
